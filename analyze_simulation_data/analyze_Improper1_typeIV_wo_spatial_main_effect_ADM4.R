...
typeIV_formula_woSpatial_second_level <- update(base_formula_second_level,
                                      ~. + f(space.time, 
                                             model = "generic0",
  ...
  tryCatch(
    {
      ...
      tmp_ = inla(typeIV_formula_woSpatial_second_level, 
                  data = data, 
                  family = "poisson",
                  E = E_it, #E_it
...
################################################################################
# SC2
model_name = "Improper1_typeIV_woSpatial"
scenario_name = "sc2"
