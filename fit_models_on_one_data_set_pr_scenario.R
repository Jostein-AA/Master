...
for(scenario_name in scenario_names_ADM4){
  ...
  # Save the INLA-objects
  save(Improper1_noInt_ADM4,
       #Improper2_noInt_ADM4,
       Improper1_typeI_ADM4,
       Improper2_typeI_ADM4,
       Improper1_typeII_ADM4,
       Improper2_typeII_ADM4,
       #Improper1_typeIII_ADM4,
       Improper2_typeIII_ADM4,
       Improper1_typeIV_ADM4,
       #Improper2_typeIV_ADM4,
       proper1_noInt_ADM4,
       proper2_noInt_ADM4,
