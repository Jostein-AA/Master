...
save(risk_surface.list, 
     file = "./Simulated_risk_surfaces/sc2_risk_surface_2.RData")

save(lambda.df,
     file = "./Simulated_data/sc2_data_2.RData")
...
save(risk_surface.list, 
     file = "./Simulated_risk_surfaces/sc4_risk_surface_2.RData")

save(lambda.df,
     file = "./Simulated_data/sc4_data_2.RData")
...
save(risk_surface.list, 
     file = "./Simulated_risk_surfaces/sc6_risk_surface_2.RData")

save(lambda.df,
     file = "./Simulated_data/sc6_data_2.RData")
...
save(risk_surface.list, 
     file = "./Simulated_risk_surfaces/sc8_risk_surface_2.RData")

save(lambda.df,
     file = "./Simulated_data/sc8_data_2.RData")
...
save(risk_surface.list, 
     file = "./Simulated_risk_surfaces/sc10_risk_surface_2.RData")

save(lambda.df,
     file = "./Simulated_data/sc10_data_2.RData")
...
save(risk_surface.list, 
     file = "./Simulated_risk_surfaces/sc12_risk_surface_2.RData")

save(lambda.df,
     file = "./Simulated_data/sc12_data_2.RData")