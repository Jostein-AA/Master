...
proper2_RW1_Spain_del_Extremadura = inla(proper2_RW1_formula, 
                               data = Data_LungCancer, 
                               family = "poisson",
                               E = pop, 
                               verbose = T,
...
save(proper2_RW1_Spain_del_Extremadura,
     file = "./case_study/proper2_RW1_Spain_del_Extremadura.RData")